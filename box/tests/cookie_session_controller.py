...
"""获取cookie"""
@geobox.route('/get/cookie/username')
def get_cookie_user():
    # 为None
...
"""设置cookie"""
@geobox.route('/set/cookie/<username>')
...
"""设置session"""
@geobox.route('/session/login', methods=['GET', 'POST'])
def login():
