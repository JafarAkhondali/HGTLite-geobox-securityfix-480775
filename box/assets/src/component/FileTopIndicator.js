...
class FileTopIndicator extends React.Component {
        ...
        render() {
            ...
            return ( < div >
                    ...
                    "btn btn-all-files opacity75 to-m-left8" > 所有文件 < /Button></Col >
                    < Col md = {
                        4
                    } > < /Col> < Col md = {
                    2
...
className = "progress-bar" >
    < span className = "progress-bar-text" > 0 % < /span> < /div > < /div> < /fieldset > < /div>

< /Modal.Body> < Modal.Footer id = "uploadFooter" > < Button onClick = {
this.close.bind(this)
