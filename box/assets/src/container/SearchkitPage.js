        ...
        <div className={bemBlocks.item().mix(bemBlocks.container("item"))} data-qa="hit">
            <a href={url} target="_blank">
                <img data-qa="poster" alt="presentation" className={bemBlocks.item("poster")}
                     src={result._source.poster} width="170" height="240"/>
            ...
            <SearchkitProvider searchkit={searchkit}>
                <Layout>
                    <TopBar>
                        ...
                        <div className="my-logo rgb-white-pure">Supersu所有文件</div>
                    ...
                    <LayoutBody>
                        ...
                        <SideBar>
                            ...
                            <RangeFilter min={0} max={10} field="imdbRating" id="imdbRating" title="IMDB Rating"
                                         showHistogram={true}/>
                            <InputFilter id="writers" searchThrottleTime={500} title="Writers"
                                         placeholder="Search writers" searchOnChange={true} queryFields={["writers"]}/>
                            <RefinementListFilter id="actors" title="Actors" field="actors.raw" size={10}/>
                            <RefinementListFilter translations={{"facets.view_more": "View more writers"}} id="writers"
                                                  title="Writers" field="writers.raw" operator="OR" size={10}/>
                            <RefinementListFilter id="countries" title="Countries" field="countries.raw" operator="OR"
                                                  size={10}/>
                            <NumericRefinementListFilter id="runtimeMinutes" title="按长度" field="runtimeMinutes"
                                                         options={[
                                                             {title: "All"},
                        ...
                        <LayoutResults>
                            ...
                            <ViewSwitcherHits
                                ...
                                hitComponents={[
                                    {key: "grid", title: "小图", itemComponent: MovieHitsGridItem, defaultOption: true},
                                    {key: "list", title: "列表", itemComponent: MovieHitsListItem}
                                ]}
                                scrollTo="body"
                            />
